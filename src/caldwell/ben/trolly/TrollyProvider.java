...
public class TrollyProvider extends ContentProvider {
    ...
    private static String DATABASE_NAME = "trolly.db";
...
//        }
    ...
    static {
        ...
        sUriMatcher.addURI(Trolly.AUTHORITY, "shoppinglist2", ITEMS);
        sUriMatcher.addURI(Trolly.AUTHORITY, "shoppinglist2/#", ITEM_ID);
